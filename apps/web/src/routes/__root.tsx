...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-display text-2xl text-foreground">Something burned in the kitchen</h1>
        <p className="mt-2 text-sm text-muted-foreground">
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Mise — Kitchen OS" },
      {
        ...
        content:
          "Schema.org-native recipes, meal plans, pantry, and shopping for households and restaurants.",
      },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "/mise-share.png" },
      { property: "og:image:width", content: "1280" },
      { property: "og:image:height", content: "640" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "/mise-share.png" },
    ],
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,400;0,9..144,500;0,9..144,600;1,9..144,400&family=Geist:wght@400;500;600;700&display=swap",
      },
    ],
  }),
